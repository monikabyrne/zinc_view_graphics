...
class ZincViewGraphics(QtGui.QMainWindow):
    ...
    def setupModel(self):
        ...
        isosurfaces.setListIsovalues(1);
        gold = materialmodule.findMaterialByName('gold')
        isosurfaces.setMaterial(gold)

        isosurface2 = scene.createGraphicsContours()
        isosurface2.setCoordinateField(coordinates)
        isosurface2.setIsoscalarField(mag)
        isosurface2.setListIsovalues(0.5);
        silver = materialmodule.findMaterialByName('silver')
        isosurface2.setMaterial(silver)
        ...
        isosurface2.setTessellation(fineTessellation)
